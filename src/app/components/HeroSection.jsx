    ...
    /></h1>
        ...
        <div className="">
            ...
            <button  className="  px-1 py-1 rounded-full mr-4 bg-gradient-to-br from-blue-400 via-purple-500 to-pink-400  hover:bg-slate-800 text-white mt-3" download>
                <span className="block bg-[#121212] hover:bg-white hover:text-black hover:font-bold rounded-full px-5 py-2"><a href="/images/AyushSupakar_CV290325.pdf">Resume</a></span>
            </button>
