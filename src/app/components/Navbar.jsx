...
function Navbar() {
  ...
  return (
    <nav className='fixed w-full left-0 right-0 top-0 z-10 bg-[#121212] bg-opacity-80x backdrop-blurx px-3 py-4 '>
        <div className="flex flex-wrap items-center justify-between mx-auto px-4 py-2">
            <Link href={"/"} className='text-2xl md:text-4xl text-white font-semibold'><span className='flex gap-2'> Ayush <span className='hidden md:flex lg:flex xl:flex 2xl:flex'> Anshuman </span> Supakar</span></Link>
